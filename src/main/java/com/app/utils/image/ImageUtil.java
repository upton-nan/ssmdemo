...
public class ImageUtil {
     ...
     * 
     * @Title: addWaterMark
     * @Description: 添加图片水印操作(物理存盘,使用默认格式)
     * @param imgPath 待处理图片
     * @param markPath 水印图片
     ...
     * 
     * @Title: addTextMark
     * @Description: 添加文字水印操作(物理存盘,使用默认格式)
     * @param imgPath 待处理图片
     * @param text 水印文字    
     ...
     * 
     * @Title: compressImage
     * @Description: 压缩图片操作(文件物理存盘,使用默认格式)
     * @param imgPath 待处理图片
     ...
     * 
     * @Title: compressImage
     * @Description: 压缩图片操作(文件物理存盘,可自定义格式)
     * @param imgPath 待处理图片
     * @param quality 图片质量(0-1之間的float值)
     * @param width 输出图片的宽度    输入负数参数表示用原来图片宽
     * @param height 输出图片的高度    输入负数参数表示用原来图片高
     ...
     * 
     * @Title: compressImage
     * @Description: 压缩图片操作,返回BufferedImage对象
     * @param imgPath 待处理图片
     * @param quality 图片质量(0-1之間的float值)
     * @param width 输出图片的宽度    输入负数参数表示用原来图片宽
     * @param height 输出图片的高度    输入负数参数表示用原来图片高
     ...
     * 
     * @Title: imageGray
     * @Description: 图片黑白化操作(文件物理存盘,使用默认格式)
     ...
     * 
     * @Title: imageGray
     * @Description: 图片黑白化操作(文件物理存盘,可自定义格式)
     * @param imgPath 处理的图片对象
     * @param format 图片格式
     * @param destPath 目标文件地址
     * @throws Exception
     ...
     * 
     * @Title: imageLucency
     * @Description: 图片透明化操作(文件物理存盘,使用默认格式)
     * @param imgPath 图片路径
     ...
     * 
     * @Title: imageLucency
     * @Description: 图片透明化操作(文件物理存盘,可自定义格式)
     * @param imgPath 图片路径
     * @param format 图片格式
     * @param destPath 图片存放路径
     * @throws Exception
     ...
     * 
     * @Title: imageLucency
     * @Description: 图片透明化操作返回BufferedImage对象
     * @param imgPath 图片路径
     * @return 透明化后的图片对象
     * @throws Exception
     */
