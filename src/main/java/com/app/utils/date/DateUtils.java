...
public class DateUtils {
	 ...
	 * 
	 * @Title: string2Date
	 * @Description: 字符串转换为日期，字符串日期格式为yyyy-MM-dd hh:mm:ss 
	 * @param value
	 * @return
	 */
	 ...
	 * 
	 * @Title: compareDate
	 * @Description: 比较两个日期相隔多少天(月、年)<br>
	 * compareDate("2012-09-12", null, 0);//比较天 <br>
     * compareDate("2012-09-12", null, 1);//比较月 <br> 
     * compareDate("2012-09-12", null, 2);//比较年 <br>
	 * @param startDay 需要比较的时间 不能为空(null),需要正确的日期格式 ,如：2012-09-12
     ...
     * @param startTime 需要比较的时间不能为空，且必须符合正确格式：2012-12-12 12:12:
